                        ...
                        <div className="w-full">
                            <div className="800px:flex items-center">
                                ...
                                <h5 className="text-[25px] Roboto text-black dark:text-white">
                                    ...
                                    Đánh giá khóa học • {data?.review?.length}{' '}
                                    đánh giá
                                </h5>
                            </div>
                            <br />
                            {(data?.review && [...data.review]?.reverse())?.map(
                    ...
                    <div className="w-full 800px:w-[35%] relative">
                        <div className="sticky top-[100px] left-0 w-full">
                            ...
                            <div className="flex items-center">
                                ...
                                <h5 className="pl-3 text-[25px] mt-2 line-through opacity-80 text-black dark:text-white">
                            ...
                            <div className="flex items-center">
                                {isPurchased ? (
                                    ...
                                    <div
                                        ...
                                        onClick={handleOrder}
                                    >
                                        Đăng ký học {data.price === 0 ? "" : data.price }
                                    </div>
                                )}
                            </div>
                            <br />
