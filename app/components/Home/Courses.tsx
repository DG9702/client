  ...
  return (
    <div className='my-4'>
      <div className="w-[90%] 800px:w-[80%] m-auto flex justify-center flex-col">
        <h1 className="text-center Roboto text-5xl py-2 1000px:leading-[35px] sm:text-3xl lg:text-4xl dark:text-white leading-[60px] text-[#000] font-[700] tracking-tight">
