export const styles = {
    ...
    label: "text-[16px] font-Poppins text-black dark:text-white mb-2",
    input:
      "w-full text-black dark:text-white bg-transparent border rounded-[40px] outline-none font-Poppins h-11 py-3 pl-[20px] pr-[42px]",
    button:
