  ...
  return (
    <div className="w-[90%] m-auto py-5 mb-5">
        <div className='w-full relative'>
            ...
            <div className='flex items-center'>
                <input
                    ...
                    className={`${styles.input} 1500px:!w-[60%] 1100px:w-[60%] ml-3 !mt-0`}
                />
            ...
            <p className='pb-1'>Source code includes</p>
        ...
        <div className='w-full flex items-center justify-between'>
            <div onClick={()=>prevButton()} className='w-full 800px:w-[180px] flex items-center justify-center h-[40px] bg-[#37a39a] text-center text-[#fff] rounded mt-8 cursor-pointer'>
                Prev
            </div>
            <div onClick={()=>createCourse()} className='w-full 800px:w-[180px] flex items-center justify-center h-[40px] bg-[#37a39a] text-center text-[#fff] rounded mt-8 cursor-pointer'>
                {
