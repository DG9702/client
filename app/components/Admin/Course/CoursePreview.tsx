  ...
  return (
    <div className="w-[80%] m-auto py-5 mb-5">
        <div className='w-full relative'>
            ...
            <div className="flex items-center">
                <div className={`${styles.button} !w-[180px] my-3 Roboto !bg-[crimson] cursor-not-allowed`}>
                    Buy Now {courseData?.price} VNĐ
        ...
        <div className='w-full flex items-center justify-between'>
            <div onClick={()=>prevButton()} className='w-full 800px:w-[180px] flex items-center justify-center h-[40px] bg-[#2190ff] text-center text-[#fff] rounded mt-8 cursor-pointer'>
                Quay lại
            </div>
            <div onClick={()=>createCourse()} className='w-full 800px:w-[180px] flex items-center justify-center h-[40px] bg-[#2190ff] text-center text-[#fff] rounded mt-8 cursor-pointer'>
                {
