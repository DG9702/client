...
const CourseContent:FC<Props> = ({
    ...
    const [activeSectionIndex, setActiveSectionIndex] = useState<number | null>(null); // State to track active section
    ...
    const handleAddSection = () => {
        ...
        const newSection = { id: nextSectionId, section: `Tiêu đề chương ${nextSectionId}`, tracks: [] };
        setSections([...sections, newSection]);
        setActiveSectionIndex(nextSectionId);
    };
    const handleDeleteSection = (sectionIndex: number) => {
        setSections(sections.filter((section: any, index: any) => index !== sectionIndex));
    };
    ...
    const handleDeleteTrack = (sectionIndex: number, trackIndex: number) => {
        const updatedSections = [...sections];
        const section = updatedSections[sectionIndex];
        section.tracks = section.tracks.filter((section: any, i: number) => i !== trackIndex);
        setSections(updatedSections);
        setPosition(position-1);
    };
        ...
        <div className='w-[80%] m-auto mt-24 p-3'>
            <form onSubmit={handleSubmit}>
                {sections.map((section: any, index: any) => {
                    const activeSectionIndex=index===0||section.section!==sections[index-1].section;
                    return (
                        <>
                            <div className={`w-full dark:bg-[#121212] bg-[#00000008] bg-white border dark:border-none shadow-xl rounded-2xl p-8 ${
                                index ? "mt-10" : "mb-0"
                                }`}
                            >
                                {
                                        ...
                                        <>
                                            <div className='flex justify-between'>
                                                ...
                                                <div className="text-end">
                                                    <AiOutlineDelete
                                                        className={`${index===0 ? "cursor-no-drop" : "cursor-pointer"} text-black dark:text-white text-[20px]`}
                                                        onClick={() => index === 0? null:handleDeleteSection(index)}  
                                                    />
                                                </div>
                                            </div>
                                            <br />
                                ...
                                {section.tracks.map((track: any, trackIndex: number) => (
                                    <div key={trackIndex}>    
                                        <div className='flex w-full items-center justify-between my-0'>
                                            {
                                                isCollapsed[trackIndex] ? (
                                                    <>
                                                        {track.title ? (
                                                            <p className='font-Poppins dark:text-white text-black cursor-pointer'>
                                            ...
                                            <div className='flex items-center'>
                                                ...
                                                <MdOutlineKeyboardArrowDown
                                                    ...
                                                    style={{
                                                        transform:isCollapsed[trackIndex] 
                                                        ? "rotate(180deg)" 
                                                        : "rotate(0deg)",
                                                    }}
                                                    onClick={()=>handleCollapseToggle(trackIndex)}
                                                ...
                                                <>
                                                        <div className='mt-4' key={trackIndex}>
                                                            {track.typeTrack==="lesson"&&(
                                                                <>
                                                                    <div className='my-3'>
                                                                        <label className={styles.label}>Tiêu đề bài giảng dạng video</label>
                                                                        <div
                                                                        ...
                                                                        >
                                                                            <input
                                                                                ...
                                                                                value={track.title}
                                                                                    ...
                                                                                    const updatedSections = [...sections];
                                                                                    const updatedSection = updatedSections[index];
                                                                                    updatedSection.tracks[trackIndex].title = e.target.value;
                                                                                    setSections(updatedSections);
                                                                                }}
                                                                            />
                                                                        </div>
                                                                    ...
                                                                    <div className='my-3'>
                                                                        <label className={styles.label}>Mô tả bài giảng</label>
                                                                        <div
                                                                            className='relative flex justify-center border 
                                                                            border-[#dee3e9] rounded items-center my-2'
                                                                        >
                                                                            <textarea
                                                                                ...
                                                                                onChange={(e)=>{
                                                                                    const updatedSections = [...sections];
                                                                                    const updatedSection = updatedSections[index];
                                                                                    updatedSection.tracks[trackIndex].description = e.target.value;
                                                                                    setSections(updatedSections);
                                                                                }}
                                                                    ...
                                                                    <div className='my-3'>
                                                                        <label className={styles.label}>Url bài giảng</label>
                                                                        <div
                                                                            className='relative flex justify-center border 
                                                                            border-[#dee3e9] rounded items-center my-2'
                                                                        >
                                                                            <input
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    const updatedSections = [...sections];
                                                                                    const updatedSection = updatedSections[index];
                                                                                    updatedSection.tracks[trackIndex].videoUrl = e.target.value;
                                                                                    setSections(updatedSections);
                                                                                }}
                                                                            />
                                                                        </div>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    const updatedSections = [...sections];
                                                                                    const updatedSection = updatedSections[index];
                                                                                    updatedSection.tracks[trackIndex].duration = parseInt(e.target.value); // Convert to integer
                                                                                    setSections(updatedSections);
                                                                                }}
                                                                            />
                                                                        </div>
                                                                    ...
                                                                    <div className='mt-2'>
                                                                        {
                                                                            track?.links?.map((link:any,linkIndex:number)=>(
                                                                                <div className='mb-3 block' key={linkIndex}>
                                                                                    <div className='w-full flex items-center justify-between'>
                                                                                        ...
                                                                                        <AiOutlineDelete
                                                                                            className={`${linkIndex===0 ? "cursor-no-drop" : "cursor-pointer"} text-black dark:text-white text-[20px]`}                                                 onClick={()=>linkIndex===0 ? null : handleRemoveLink(trackIndex, linkIndex)}  
                                                                                        />
                                                                                    </div>
                                                                                    <div
                                                                                        className='relative flex justify-center border 
                                                                                    ...
                                                                                    >
                                                                                        <input
                                                                                            ...
                                                                                            onChange={(e) => {
                                                                                                const updatedSections = [...sections];
                                                                                                const updatedSection = updatedSections[index];
                                                                                                updatedSection.tracks[trackIndex].links[linkIndex].title = e.target.value;
                                                                                                setSections(updatedSections);
                                                                                            }}
                                                                                        />
                                                                                    </div>
                                                                                    ...
                                                                                    >
                                                                                        <input
                                                                                            ...
                                                                                            onChange={(e) => {
                                                                                                const updatedSections = [...sections];
                                                                                                const updatedSection = updatedSections[index];
                                                                                                updatedSection.tracks[trackIndex].links[linkIndex].url = e.target.value;
                                                                                                setSections(updatedSections);
                                                                                            }}
                                                                                        />
                                                                                    </div>
                                                                        ...
                                                                        <div className='inline-block mb-4'>
                                                                            <p onClick={()=> handleAddLink(index, trackIndex)} className='flex items-center text-[18px] dark:text-white text-black cursor-pointer'>
                                                                                <IoIosLink className="mr-2"/>Thêm liên kết
                                                                            </p>
                                                            ...
                                                            {track.typeTrack==="quiz"&&(
                                                                <>
                                                                    <div className='my-3'>
                                                                        <label className={styles.label}>Tiêu đề câu hỏi</label>
                                                                        <div
                                                                            className='relative flex justify-center border 
                                                                            border-[#dee3e9] rounded items-center my-2'
                                                                        >
                                                                    ...
                                                                    <div className='my-3'>
                                                                        <label className={styles.label}>Mô tả câu hỏi</label>
                                                                        <div
                                                                            className='relative flex justify-center border 
                                                                            border-[#dee3e9] rounded items-center my-2'
                                                                        >
                                                                        ...
                                                                        >
                                                                            <input
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    const updatedSections = [...sections];
                                                                                    const updatedSection = updatedSections[index];
                                                                                    updatedSection.tracks[trackIndex].content = e.target.value;
                                                                                    setSections(updatedSections);
                                                                                }}
                                                                            />
                                                                        </div>
                                                                    ...
                                                                    <div className='mt-2'>
                                                                        {
                                                                            track.questions.map((question: any, questionIndex: number) => (
                                                                                <div className='mb-3 block' key={questionIndex}>
                                                                                    <div className='w-full flex items-center justify-between'>
                                                                                        ...
                                                                                        <AiOutlineDelete
                                                                                            className={`${questionIndex===0 ? "cursor-no-drop" : "cursor-pointer"} text-black dark:text-white text-[20px]`}                                                 onClick={()=>questionIndex===0 ? null : handleRemoveQuestions(trackIndex,questionIndex)}  
                                                                                        />
                                                                                    </div>
                                                                                    <div
                                                                                        className='relative flex justify-center border 
                                                                                    ...
                                                                                    >
                                                                                        <input
                                                                                            ...
                                                                                            onChange={(e) => {
                                                                                                const updatedSections = [...sections];
                                                                                                const updatedSection = updatedSections[index];
                                                                                                updatedSection.tracks[trackIndex].questions[questionIndex].answer = e.target.value;
                                                                                                setSections(updatedSections);
                                                                                            }}
                                                                                        />
                                                                                    </div>
                                                                                    ...
                                                                                    >
                                                                                        <input
                                                                                            ...
                                                                                            onChange={(e) => {
                                                                                                const updatedSections = [...sections];
                                                                                                const updatedSection = updatedSections[index];
                                                                                                updatedSection.tracks[trackIndex].questions[questionIndex].explanation = e.target.value;
                                                                                                setSections(updatedSections);
                                                                                            }}
                                                                                        />
                                                                                    </div>
                                                                                    <div className='flex items-center '>
                                                                                        <label className={`${styles.label} mr-2`}>
                                                                                            Đây là đáp án đúng?
                                                                                        </label>
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            onChange={() => {
                                                                                                ...
                                                                                                if(question.is_Correct===false) {
                                                                                                    updatedSection.tracks[trackIndex].questions[questionIndex].is_Correct = true;
                                                                                                }
                                                                                                setSections(updatedSections);
                                                                                            }}
                                                                                        />
                                                                        ...
                                                                        {/*add question button*/}
                                                                        <div className='inline-block mb-4'>
                                                                            <p onClick={()=> handleAddQuestions(index, trackIndex)} className='flex items-center text-[18px] dark:text-white text-black cursor-pointer'>
                                                                                <IoIosLink className="mr-2"/>Thêm đáp án
                                                                            </p>
                                ...
                                {index===sections.length-1 && (
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                                <option value="" className="dark:bg-black">Lựa chọn kiểu bài học</option>
                                                {selectTypetrack &&
                                                    selectTypetrack.map((item: any, index: any) => (
                                                    <option className="dark:bg-black" value={item.title} key={index}>
                                                        {item.title}
                                                    </option>
                                                ))}
                                            </select>
