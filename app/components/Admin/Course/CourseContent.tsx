...
const CourseContent:FC<Props> = ({
    ...
    const newContentHandler=(item:any)=>{
        if(item.title==="" || item.description==="" || item.videoUrl==="" || item.links[0].url===""){
            toast.error("Please fill al the fields first!")
        }else{
            let newVideoSection="";
                                ...
                                !isCollapsed[index] && (
                                    <>
                                        ...
                                        <div className='inline-block mb-4'>
                                            <p onClick={()=>handleAddLink(index)} className='flex items-center text-[18px] dark:text-white text-black cursor-pointer'>
                                                <IoIosLink className="mr-2"/>Add Link
                                            </p>
